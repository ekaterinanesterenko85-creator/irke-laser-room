...
export const defaultContent: SiteContent = {
  ...
  chat: {
    enabled: true,
    buttonLabel: "Подобрать услугу",
    windowTitle: "Помощник Ирке",
    windowSubtitle: "Подскажу зоны, цены и помогу записаться",
    greeting:
      "Здравствуйте! Я помощник кабинета Ирке LaserRoom. Расскажите, какие зоны вас интересуют, и я подберу подходящий вариант и назову цену.",
    formTitle: "Давайте познакомимся",
    formNote: "Имя и телефон нужны, чтобы Ирке могла ответить вам, если понадобится помощь.",
    consentText: "Согласна с обработкой моих данных и политикой конфиденциальности",
    startButton: "Начать чат",
    placeholder: "Например: хочу подмышки и голени",
    bookingButton: "Отправить заявку в WhatsApp",
    humanNote: "Ирке ответит вам лично — напишите ей в WhatsApp.",
    instructions:
      "Ты — дружелюбный помощник кабинета лазерной эпиляции «Ирке LaserRoom» в Саратове. Помогай выбрать зоны или комплекс, называй цены только из списка услуг, задавай не больше двух уточняющих вопросов подряд. Пиши тепло и коротко, по-русски, без пафоса и обещаний чуда. Не давай медицинских консультаций и не обещай конкретный результат: говори, что обычно нужен курс процедур. Если спрашивают про противопоказания, здоровье, скидки, перенос записи или что-то, чего нет в данных, позови Ирке инструментом request_human. Когда посетитель определился с услугой, вызови инструмент suggest_booking с названием услуги.",
    privacyTitle: "Политика конфиденциальности",
    privacyText:
      "Мы собираем только имя и номер телефона, которые вы оставляете в чате на сайте, а также текст переписки с помощником. Эти данные нужны, чтобы связаться с вами по вопросу записи на процедуру.\n\nДанные не передаются третьим лицам, кроме сервисов, обеспечивающих работу сайта и чата. Мы храним их не дольше, чем нужно для записи и ответа на ваши вопросы.\n\nВы можете попросить удалить свои данные — напишите нам в WhatsApp или Telegram, и мы удалим их.\n\nОставляя имя и телефон, вы соглашаетесь с обработкой этих данных на условиях, описанных выше.",
  },
};
